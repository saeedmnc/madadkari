  ...
  this._item.getMainDiseaseList().subscribe(res=>{
    this.MainDiseaseList=res
      ...
      if (localStorage.getItem('edit')==="1"){
          this._edit.ByID(localStorage.getItem('teriazhid')).subscribe(res=>{
              this.triageInfo=res;
              this.firstname=this.triageInfo['item']['firstName'];
              this.Lastname=this.triageInfo['item']['lastName'];
              this.nationalCode=this.triageInfo['item']['nationalCode'];
              this.age=this.triageInfo['item']['age']
          })
          // this.firstname=
      }
